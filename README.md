...
However the current version should still work as of right now (February 2020). Of course, feel free to fork it if needed! If you like me to remove it from the store in favour of a maintained fork, please log an issue here and I'll sort this out!
